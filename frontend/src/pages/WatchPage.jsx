...
import { ORIGINAL_IMG_URL, SMALL_IMG_URL } from '../utils/constants'
        ...
        {trailers.length > 0 && (
					<div className='flex justify-between items-center mb-4'>
						...
						<button
							className={`
							bg-gray-500/70 hover:bg-gray-500 text-white py-2 px-4 rounded ${
								currentTrailersID === trailers.length - 1 ? "opacity-50 cursor-not-allowed " : ""
							}}
							`}
				...
				max-w-6xl mx-auto'>
                    ...
                    {similarContent.length>0 && (
                        <div className='mt-12 max-w-5xl mx-auto relative'>
                            ...
                            scrollbar-hide gap-4 pb-4 group' ref={sliderRef}>
