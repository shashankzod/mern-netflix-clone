  ...
  const handleFormSubmit = (e) => {
    ...
    max-w-6xl mx-auto'>
        ...
        <input
					...
					/>
					<button className='bg-red-600 text-xl lg:text-2xl px-2 lg:px-6 py-1 md:py-2 rounded 
    ...
    <div className='py-10 bg-black text-white'>
      <div className='flex max-w-6xl mx-auto items-center justify-center md:flex-row flex-col 
      px-4 md:px-2'>
        {/* left side */}
        ...
        <div className='flex-1 relative'>
          <img src='/tv (1).png' alt='TV image' className='mt-4 z-20 relative' />
    ...
    <div className='py-10 bg-black text-white'>
      <div className='flex max-w-6xl mx-auto items-center justify-center md:flex-row flex-col-reverse 
      px-4 md:px-2'>
        {/* Left side */}
        <div className='flex-1'>
          ...
          bg-black w-3/4 lg:w-1/2 h-24 border border-slate-500 rounded-md px-2 '>
    ...
    <div className='py-10 bg-black text-white'>
      ...
      px-4 md:px-2'>
        ...
        <div className='flex-1 relative overflow-hidden'>
          ...
          <video className='absolute top-2 left-1/2 -translate-x-1/2 h-4/6 
          z-10 max-w-[63%]'
          playsInline
          autoPlay={true}
          muted
